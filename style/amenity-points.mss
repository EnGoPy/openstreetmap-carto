...
@shop-icon: #F29900;
@shop-text: #D7730B;
@transportation-icon: #7986CB;
@transportation-text: #7986CB;
@accommodation-icon: @transportation-icon;
@accommodation-text: @transportation-text;
@airtransport: #8461C4; //also ferry_terminal
@health-color: #EE675C;
@amenity-brown: #12B5CB;
@gastronomy-icon: #F29900;
@gastronomy-text: #D7730B;
...
#amenity-points {
  ...
  [feature = 'tourism_camp_site'][zoom >= 19] {
  ...
  [feature = 'tourism_chalet'][zoom >= 19] {
    marker-file: url('symbols/tourism/chalet.svg');
    marker-fill: @accommodation-icon;
    marker-clip: false;
  }

  [feature = 'amenity_cinema'][zoom >= 19] {
  ...
  [feature = 'amenity_charging_station'][zoom >= 19] {
  ...
  [feature = 'tourism_viewpoint'][zoom >= 18] {
  ...
  [feature = 'historic_castle'][castle_type != 'stately'][castle_type != 'manor'][zoom >= 17],
  ...
  [feature = 'amenity_marketplace'][zoom >= 18][way_pixels > 3000],
  ...
  [feature = 'shop'] {
    ...
    [zoom >= 18][zoom < 19][shop != 'supermarket'][shop != 'department_store'][shop != 'mall'][shop != 'massage'] {
      marker-width: 4;
      marker-line-width: 0;
    }
    ...
    [shop = 'beverages'][zoom >= 19] {
      marker-file: url('symbols/shop/beverages.svg');
    }

    [shop = 'bookmaker'][zoom >= 19] {
    ...
    [shop = 'charity'][zoom >= 19] {
      marker-file: url('symbols/shop/charity.svg');
    }

    [shop = 'chemist'][zoom >= 19] {
    ...
    [shop = 'chocolate'][zoom >= 19],
    [shop = 'confectionery'][zoom >= 19],
    [shop = 'pastry'][zoom >= 19] {
      marker-file: url('symbols/shop/confectionery.svg');
    }

    [shop = 'copyshop'][zoom >= 19] {
    ...
    [shop = 'florist'][zoom >= 19] {
      marker-file: url('symbols/shop/florist.svg');
    }

    [shop = 'garden_centre'][zoom >= 19] {
    ...
    [shop = 'car_parts'][zoom >= 19] {
      marker-file: url('symbols/shop/car_parts.svg');
    }

    [shop = 'car_repair'][zoom >= 19] {
    ...
    [shop = 'outdoor'][zoom >= 19] {
      marker-file: url('symbols/shop/outdoor.svg');
    }

    [shop = 'furniture'][zoom >= 19] {
    ...
    [shop = 'musical_instrument'][zoom >= 19] {
  ...
  [feature = 'leisure_golf_course'][zoom >= 18] {
...
#text-point[zoom >= 10] {
  ...
  [feature = 'amenity_ice_cream'][zoom >= 19] {
    ...
    text-size: @standard-shop-font-size;
  ...
  [feature = 'amenity_post_office'][zoom >= 18],
  [feature = 'amenity_prison'][zoom >= 18],
  [feature = 'amenity_embassy'][zoom >= 18],
  [feature = 'amenity_bank'][zoom >= 18] {
    text-name: "[name]";
    text-size: @standard-font-size;
    text-wrap-width: @standard-wrap-width;
  ...
  [feature = 'natural_peak'][zoom >= 16],
  [feature = 'natural_volcano'][zoom >= 17],
  [feature = 'natural_saddle'][zoom >= 17],
  ...
  [feature = 'historic_fort'][zoom >= 18],
  [feature = 'historic_castle'][zoom >= 18],
  [feature = 'historic_manor'][zoom >= 18] {
    text-name: "[name]";
    text-size: @standard-font-size;
    text-wrap-width: @standard-wrap-width;
    text-line-spacing: @standard-line-spacing-size;
  ...
  [feature = 'shop_department_store'] {
    [zoom >= 17] {
      ...
      text-face-name: @standard-font;
      text-halo-radius: @standard-halo-radius;
      text-halo-fill: rgba(0, 0, 0, 0.69);
    }
  }
  ...
  [feature = 'tourism_attraction'][zoom >= 19][is_building = 'no'] {
    text-name: "[name]";
    text-size: @standard-font-size;
    text-wrap-width: @standard-wrap-width;
    text-line-spacing: @standard-line-spacing-size;
